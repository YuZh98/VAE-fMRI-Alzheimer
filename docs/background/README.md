...
- [`vae_for_neuroimaging.md`](vae_for_neuroimaging.md) — A tour of
  variational autoencoders for a reader who already knows PCA, ICA,
  and the GLM, plus how the recurrent-VAE family sits among other deep
  learning approaches to fMRI.
- [`this_models_design.md`](this_models_design.md) — A walkthrough of
  why each architectural and training choice in `recvae/model.py` was
  made, with the weak spots flagged explicitly.
